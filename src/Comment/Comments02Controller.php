 ...
 *
 */
class Comments02Controller implements \Anax\DI\IInjectionAware
{
    ...
    public function viewAddAction($pageKey)
    {
        ...
        $this->views->add('comment/form', $formValues, 'main');
    }
    /**
    ...
    public function viewEditAction($pageKey, $id)
    {
        ...
        $this->theme->addStylesheet('css/form.css');
        $this->setIndexPageTitle($pageKey);
        $this->views->add('comment/editForm', $formValues, 'main');
    }
    /**
     * Edit a comment.
     *
    ...
    public function viewDeleteAction($pageKey, $id)
    {
        ...
        $this->theme->addStylesheet('css/form.css');
        $this->setIndexPageTitle($pageKey);
        $this->views->add('comment/deleteForm', $formValues, 'main');
    }
    /**
     * Deletes a comment.
     *
